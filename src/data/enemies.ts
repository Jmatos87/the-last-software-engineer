...
export const enemies: Record<string, EnemyDef> = {
  ...
  linkedin_influencer: {
    ...
    moves: [
      ...
      { name: '#Blessed', type: 'attack', damage: 8, icon: '🙏', quip: '"Grateful for my 12th promotion."' },
      { name: 'Engagement Farming', type: 'attack_defend', damage: 7, block: 6, applyToSelf: { regen: 2 }, icon: '🌱', quip: '"I cried at my standing desk today."' },
    ],
  },
  ...
  networking_event: {
    ...
    isElite: true,
    moves: [
      { name: 'Small Talk', type: 'stress_attack', stressDamage: 6, icon: '💬', quip: '"So... what do you do?"' },
      ...
      { name: 'Exchange Cards', type: 'buff', applyToSelf: { strength: 2 }, icon: '📇', quip: '"Let\'s connect on LinkedIn!"' },
    ],
  },
  ...
  automated_rejection: {
    ...
    moves: [
      ...
      { name: 'We\'ll Keep You On File', type: 'stress_attack', stressDamage: 8, icon: '📁', quip: '"(We won\'t.)"' },
      { name: 'Not A Good Fit', type: 'attack', damage: 13, icon: '❌', quip: '"We\'re looking for a unicorn."' },
    ],
  },
  ...
  hr_phone_screen: {
    ...
    moves: [
      ...
      { name: 'Where Do You See Yourself?', type: 'attack', damage: 12, icon: '🔮', quip: '"In 5 years. Be specific."' },
      { name: 'Salary Expectations?', type: 'attack', damage: 14, stressDamage: 6, icon: '💵', quip: '"What\'s your current comp?"' },
      { name: 'We\'ll Be In Touch', type: 'attack', damage: 18, stressDamage: 10, icon: '☎️', quip: '"(Narrator: They weren\'t.)"' },
    ],
  },
  ...
  ats_final_form: {
    ...
    moves: [
      ...
      { name: 'TRANSFORM', type: 'buff', applyToSelf: { strength: 3 }, icon: '🔥', quip: '"THIS ISN\'T EVEN MY FINAL FORM."' },
      { name: 'Maximum Overdrive', type: 'attack', damage: 16, icon: '💥', quip: '"REJECT. REJECT. REJECT."' },
      { name: 'Total Rejection', type: 'attack', damage: 12, times: 2, icon: '❌', quip: '"Application status: OBLITERATED."' },
      { name: 'System Crash', type: 'attack', damage: 20, stressDamage: 8, icon: '💀', quip: '"Fatal error: career not found."' },
    ],
  },
  ...
  ghosting_phantom: {
    ...
    moves: [
      ...
      { name: 'Spectral Slash', type: 'attack', damage: 13, icon: '💫', quip: '"I was never even real."' },
      { name: 'Maybe Next Time', type: 'debuff', applyToTarget: { weak: 2, ghosted: 2 }, icon: '💨', quip: '"We\'ll definitely reach out soon!"' },
      { name: 'Full Ghosting', type: 'attack', damage: 15, stressDamage: 8, icon: '☠️', quip: '"The position has been filled... forever."' },
    ],
  },
  ...
  whiteboard_demon: {
    ...
    moves: [
      ...
      { name: 'Edge Case', type: 'attack', damage: 12, icon: '🔥', quip: '"What if the array is empty?"' },
  ...
  leetcode_goblin: {
    ...
    moves: [
      ...
      { name: 'Hard Problem', type: 'attack', damage: 11, icon: '🔴', quip: '"This one\'s a classic!"' },
  ...
  pair_programmer_enemy: {
    ...
    moves: [
      ...
      { name: 'Actually...', type: 'attack', damage: 9, icon: '☝️', quip: '"Well, actually, it\'s O(log n)."' },
  ...
  take_home_v2: {
    ...
    moves: [
      ...
      { name: 'Deploy Pressure', type: 'attack', damage: 11, stressDamage: 4, icon: '🚀', quip: '"Deploy to prod. No staging."' },
  ...
  the_lowballer: {
    ...
    moves: [
      ...
      { name: 'Take It Or Leave It', type: 'attack', damage: 9, icon: '🤷', quip: '"Final offer. Non-negotiable."' },
  ...
  reference_checker: {
    ...
    moves: [
      ...
      { name: 'Inconsistency Found', type: 'attack', damage: 12, icon: '⚠️', quip: '"This date doesn\'t match."' },
  ...
  senior_dev_interrogator: {
    ...
    moves: [
      ...
      { name: 'Years of Experience', type: 'buff', applyToSelf: { strength: 2 }, icon: '📅', quip: '"I\'ve been doing this since Perl."' },
    ],
  },
  ...
  whiteboard_hydra: {
    ...
    moves: [
      ...
      { name: 'Grow Heads', type: 'buff', applyToSelf: { strength: 2 }, icon: '🐲', quip: '"One more follow-up question..."' },
    ],
  },
  ...
  hr_gatekeeper: {
    ...
    moves: [
      ...
      { name: 'Access Denied', type: 'attack', damage: 14, stressDamage: 5, icon: '🚫', quip: '"You don\'t have clearance."' },
    ],
  },
  ...
  the_algorithm: {
    ...
    isElite: true,
    moves: [
      { name: 'Analyze Pattern', type: 'buff', applyToSelf: { strength: 1, dexterity: 1 }, icon: '📊', quip: '"Training on your weaknesses..."' },
      ...
      { name: 'Neural Overload', type: 'attack', damage: 16, stressDamage: 6, icon: '🧠', quip: '"Processing power: MAXIMUM."' },
    ],
  },
  ...
  crunch_time_manager: {
    ...
    moves: [
      ...
      { name: 'Overtime Mandate', type: 'buff', applyToSelf: { strength: 2 }, icon: '📈', quip: '"We\'re all pulling extra hours!"' },
      ...
      { name: 'All-Hands Pressure', type: 'attack', damage: 18, stressDamage: 8, icon: '💥', quip: '"The board is watching."' },
    ],
  },
  ...
  panel_interview_hydra: {
    ...
    moves: [
      ...
      { name: 'Final Verdict', type: 'attack', damage: 18, stressDamage: 8, icon: '⚖️', quip: '"The panel has decided."' },
    ],
  },
  ...
  live_coding_challenge: {
    ...
    moves: [
      ...
      { name: 'Compiler Fury', type: 'buff', applyToSelf: { strength: 3 }, icon: '🔥', quip: '"142 errors found."' },
      ...
      { name: 'TIME\'S UP!', type: 'attack', damage: 22, stressDamage: 12, icon: '⏰', quip: '"Pencils down. Step away."' },
    ],
  },
  ...
  vp_of_engineering: {
    ...
    moves: [
      ...
      { name: 'Technical Deep-Dive', type: 'buff', applyToSelf: { strength: 3 }, icon: '🤿', quip: '"Now the real interview begins."' },
      ...
      { name: 'Executive Decision', type: 'attack', damage: 20, stressDamage: 10, icon: '⚡', quip: '"I\'ve seen enough."' },
    ],
  },
  ...
  system_design_titan: {
    ...
    icon: '🏛️',
    moves: [
      { name: 'Let\'s Talk Scalability', type: 'attack_defend', damage: 8, block: 6, icon: '📐', quip: '"Draw the architecture. All of it."' },
      { name: 'Load Balancer', type: 'defend', block: 12, icon: '⚖️', quip: '"Distributing incoming damage..."' },
      { name: 'Distributed Slam', type: 'attack', damage: 12, icon: '🌐', quip: '"Across 47 microservices!"' },
      { name: 'Microservice Barrage', type: 'attack', damage: 7, times: 2, icon: '🔧', quip: '"Each one a separate repo."' },
    ],
  },
  ...
  salary_negotiator: {
    ...
    icon: '💼',
    moves: [
      { name: 'Lowball Offer', type: 'gold_steal', goldSteal: 15, icon: '💸', quip: '"Best we can do. Economy, y\'know."' },
      { name: 'Market Rate Denial', type: 'attack', damage: 10, stressDamage: 5, icon: '📉', quip: '"Our internal bands are different."' },
      { name: 'Benefits Package', type: 'gold_steal', goldSteal: 10, stressDamage: 3, icon: '📦', quip: '"Free snacks count as comp, right?"' },
      { name: 'Final Offer', type: 'attack', damage: 14, icon: '🤝', quip: '"Take it or we move on."' },
    ],
  },
  ...
  imposter_syndrome_common: {
    ...
    moves: [
      ...
      { name: 'Spiral', type: 'attack', damage: 8, stressDamage: 6, icon: '🌀', quip: '"Google your own name lately?"' },
    ],
  },
  ...
  benefits_mimic: {
    ...
    moves: [
      ...
      { name: 'SURPRISE!', type: 'attack', damage: 18, stressDamage: 6, icon: '💥', quip: '"$5000 deductible! Gotcha!"' },
      { name: 'Fine Print', type: 'attack', damage: 10, icon: '📜', quip: '"Dental is extra. Way extra."' },
  ...
  equity_phantom: {
    ...
    moves: [
      ...
      { name: 'Paper Money', type: 'attack', damage: 9, icon: '📄', quip: '"Worth millions! On paper."' },
  ...
  non_compete_clause: {
    ...
    moves: [
      ...
      { name: 'Cease & Desist', type: 'attack', damage: 11, icon: '🚫', quip: '"Our lawyers will be in touch."' },
      { name: 'Restriction', type: 'debuff', applyToTarget: { weak: 2, dexterity: -1 }, icon: '🔗', quip: '"No working in tech for 2 years."' },
      { name: 'Court Order', type: 'attack', damage: 14, stressDamage: 5, icon: '⚖️', quip: '"See you in court. We have 40 lawyers."' },
    ],
  },
  ...
  the_pivot: {
    ...
    icon: '🔄',
    moves: [
      { name: 'Pivoting to AI', type: 'attack', damage: 12, icon: '🤖', quip: '"We\'re an AI company now."' },
      { name: 'Pivoting to Blockchain', type: 'buff', applyToSelf: { strength: 2 }, icon: '⛓️', quip: '"Web3 is definitely still a thing."' },
      { name: 'Pivoting to Cloud', type: 'attack_defend', damage: 8, block: 8, icon: '☁️', quip: '"Everything is serverless now."' },
  ...
  burnout_ember: {
    ...
    icon: '🔥',
    moves: [
      { name: 'Smolder', type: 'debuff', applyToTarget: { poison: 3 }, icon: '🔥', quip: '"You love what you do, right?"' },
      { name: 'Flare Up', type: 'attack', damage: 8, stressDamage: 5, icon: '💥', quip: '"Sunday scaries are normal."' },
      { name: 'Slow Burn', type: 'stress_attack', stressDamage: 10, icon: '🕯️', quip: '"It\'s just a phase. For 3 years."' },
      { name: 'Ember Spread', type: 'debuff', applyToTarget: { poison: 2, vulnerable: 1 }, icon: '🌋', quip: '"Your passion is your problem."' },
    ],
  },
  ...
  meeting_email: {
    ...
    icon: '📧',
    moves: [
      { name: 'Let\'s Circle Back', type: 'attack', damage: 10, icon: '🔄', quip: '"Per my last email..."' },
      { name: 'Agenda Overload', type: 'exhaust', exhaustCount: 1, stressDamage: 4, icon: '📋', quip: '"42-item agenda for a 30-min call."' },
      { name: 'Reply All Storm', type: 'attack', damage: 8, times: 2, icon: '📧', quip: '"Please remove me from this thread."' },
      { name: 'Action Items', type: 'attack', damage: 13, icon: '✅', quip: '"You own all 17 action items."' },
    ],
  },
  ...
  the_counteroffer: {
    ...
    icon: '🤝',
    moves: [
      { name: 'Match Their Offer', type: 'heal_allies', healAmount: 8, icon: '💊', quip: '"We can match... mostly."' },
      { name: 'Retention Bonus', type: 'attack', damage: 10, icon: '💰', quip: '"One-time payment. Non-negotiable."' },
      { name: 'We Value You', type: 'heal_allies', healAmount: 6, icon: '❤️', quip: '"You\'re like family! (See Act 2.)"' },
      { name: 'Guilt Trip', type: 'attack', damage: 9, stressDamage: 5, icon: '😢', quip: '"After everything we\'ve done?"' },
    ],
  },
  ...
  background_check: {
    ...
    icon: '🔎',
    moves: [
      { name: 'Deep Search', type: 'attack', damage: 10, icon: '🔎', quip: '"Found your MySpace page."' },
      { name: 'Found Something', type: 'attack', damage: 14, icon: '⚠️', quip: '"Care to explain this tweet?"' },
      { name: 'Verify Employment', type: 'debuff', applyToTarget: { vulnerable: 2, weak: 1 }, icon: '📋', quip: '"That gap year looks suspicious."' },
      { name: 'Criminal Record Scan', type: 'attack', damage: 11, stressDamage: 5, icon: '🔍', quip: '"One parking ticket in 2019..."' },
    ],
  },
  ...
  relocation_package: {
    ...
    icon: '🚚',
    moves: [
      { name: 'Palo Alto or Bust', type: 'attack', damage: 12, stressDamage: 6, icon: '🏠', quip: '"1BR for $4,500/month. Steal!"' },
      { name: 'Moving Costs', type: 'gold_steal', goldSteal: 12, icon: '💸', quip: '"We cover $500. Movers cost $8K."' },
      { name: 'Culture Shock', type: 'stress_attack', stressDamage: 10, icon: '😵', quip: '"Hope you like kombucha on tap."' },
      { name: 'Housing Crisis', type: 'attack', damage: 15, icon: '🏠', quip: '"Your commute is only 2 hours!"' },
    ],
  },
  ...
  board_member: {
    ...
    isElite: true,
    moves: [
      { name: 'Executive Order', type: 'attack', damage: 14, icon: '📜', quip: '"This came from the top."' },
      { name: 'Quarterly Review', type: 'attack_defend', damage: 10, block: 12, icon: '📊', quip: '"Numbers are down. Your fault."' },
      { name: 'Shareholder Pressure', type: 'buff', applyToSelf: { strength: 2 }, icon: '📈', quip: '"The shareholders demand growth!"' },
      { name: 'Board Decision', type: 'attack', damage: 18, stressDamage: 6, icon: '⚡', quip: '"The board has spoken."' },
    ],
  },
  ...
  golden_handcuffs: {
    ...
    isElite: true,
    moves: [
      { name: 'Vest Schedule', type: 'exhaust', exhaustCount: 1, stressDamage: 5, icon: '📅', quip: '"Your cliff is in 11 months."' },
      { name: 'Retention Hit', type: 'attack', damage: 13, icon: '⛓️', quip: '"You can\'t afford to leave."' },
      { name: 'Stock Lock', type: 'exhaust', exhaustCount: 1, icon: '🔒', quip: '"90-day exercise window. Good luck."' },
      { name: 'Golden Slam', type: 'attack', damage: 16, stressDamage: 5, icon: '💰', quip: '"Trapped by your own success!"' },
    ],
  },
  ...
  the_reorg: {
    ...
    moves: [
      ...
      { name: 'New Manager', type: 'attack', damage: 12, stressDamage: 5, icon: '👤', quip: '"Meet your 4th manager this year."' },
      { name: 'Restructure', type: 'debuff', applyToTarget: { weak: 2, vulnerable: 2 }, icon: '🌀', quip: '"Your role has been \'realigned.\'"' },
      { name: 'Layoff Wave', type: 'attack', damage: 17, stressDamage: 8, icon: '🌊', quip: '"Efficiency optimization in progress."' },
    ],
  },
  ...
  technical_debt_golem: {
    ...
    isElite: true,
    moves: [
      { name: 'Legacy Code', type: 'attack', damage: 8, icon: '📟', quip: '"This was written in jQuery. In 2024."' },
      { name: 'Accumulate', type: 'buff', applyToSelf: { strength: 3 }, icon: '📈', quip: '"TODO: fix later (2019)"' },
      { name: 'Spaghetti Strike', type: 'attack', damage: 12, icon: '🍝', quip: '"One file. 14,000 lines."' },
      { name: 'Technical Bankruptcy', type: 'attack', damage: 16, stressDamage: 6, icon: '💥', quip: '"No tests. No docs. No hope."' },
    ],
  },
  ...
  the_pip: {
    ...
    moves: [
      ...
      { name: 'Final Warning', type: 'attack', damage: 14, stressDamage: 6, icon: '⚠️', quip: '"This is your last chance."' },
      { name: 'Terminated', type: 'attack', damage: 20, stressDamage: 10, icon: '🚪', quip: '"Security will escort you out."' },
    ],
  },
  ...
  offer_committee: {
    ...
    moves: [
      ...
      { name: 'Counter-Counter Offer', type: 'attack', damage: 18, stressDamage: 8, icon: '⚖️', quip: '"We counter your counter. Again."' },
      { name: 'Committee Slam', type: 'attack', damage: 22, icon: '💥', quip: '"Motion to reject. All in favor?"' },
    ],
  },
  ...
  the_ceo: {
    ...
    moves: [
      ...
      { name: 'Corporate Strategy', type: 'attack_defend', damage: 10, block: 10, icon: '📊', quip: '"It\'s a paradigm shift."' },
      // Phase 2: "Execution" — heavy damage
      { name: 'Execute!', type: 'attack', damage: 16, icon: '⚡', quip: '"Ship it or I ship you out."' },
      { name: 'Disruption', type: 'attack', damage: 14, stressDamage: 6, icon: '💥', quip: '"We disrupted the disruptors."' },
      // Phase 3: "Disruption" — chaos
      { name: 'Move Fast Break Things', type: 'attack', damage: 20, icon: '🔥', quip: '"Including your career!"' },
      { name: 'Golden Parachute', type: 'buff', applyToSelf: { strength: 3 }, icon: '🪂', quip: '"I have a $50M exit package."' },
      { name: 'Hostile Takeover', type: 'attack', damage: 24, stressDamage: 12, icon: '☠️', quip: '"I AM the company."' },
    ],
  },
  ...
  imposter_syndrome_final: {
    ...
    moves: [
      ...
      { name: 'They\'ll Find Out', type: 'attack', damage: 10, stressDamage: 10, icon: '😱', quip: '"Day one. They\'ll know."' },
      ...
      { name: 'Complete Meltdown', type: 'attack', damage: 15, stressDamage: 20, icon: '🔥', quip: '"EVERYTHING IS FALLING APART."' },
    ],
  },
};
