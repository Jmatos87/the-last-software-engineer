...
export const enemies: Record<string, EnemyDef> = {
  ...
  hr_phone_screen: {
    ...
    moves: [
      ...
      // Phase 2: aggressive (indices 3-5)
  ...
  ats_final_form: {
    ...
    moves: [
      ...
      { name: 'System Crash', type: 'attack', damage: 22, stressDamage: 8, icon: '💀', quip: '"Fatal error: career not found."' },
    ],
  },
  ...
  ghosting_phantom: {
    ...
    moves: [
      ...
      { name: 'Full Ghosting', type: 'attack', damage: 17, stressDamage: 8, icon: '☠️', quip: '"The position has been filled... forever."' },
    ],
  },
  ...
  the_algorithm: {
    ...
    moves: [
      ...
      { name: 'Neural Overload', type: 'attack', damage: 18, stressDamage: 8, icon: '🧠', quip: '"Processing power: MAXIMUM."' },
    ],
  },
  ...
  crunch_time_manager: {
    ...
    moves: [
      ...
      { name: 'All-Hands Pressure', type: 'attack', damage: 20, stressDamage: 10, icon: '💥', quip: '"The board is watching."' },
    ],
  },
  ...
  panel_interview_hydra: {
    ...
    isBoss: true,
    phases: [
      { hpPercent: 50, moveStartIndex: 3, onEnter: { strength: 2, dexterity: 1 }, quip: '"The panel has reached a consensus."' },
    ],
    moves: [
      // Phase 1 (indices 0-2)
      ...
      { name: 'Final Verdict', type: 'attack', damage: 20, stressDamage: 10, icon: '⚖️', quip: '"The panel has decided."' },
    ],
  },
  ...
  live_coding_challenge: {
    ...
    moves: [
      ...
      { name: 'TIME\'S UP!', type: 'attack', damage: 25, stressDamage: 14, icon: '⏰', quip: '"Pencils down. Step away."' },
    ],
  },
  ...
  vp_of_engineering: {
    ...
    isBoss: true,
    phases: [
      { hpPercent: 50, moveStartIndex: 4, onEnter: { strength: 3 }, quip: '"Now the real interview begins."' },
    ],
    moves: [
      ...
      { name: 'Executive Decision', type: 'attack', damage: 24, stressDamage: 12, icon: '⚡', quip: '"I\'ve seen enough."' },
    ],
  },
  ...
  board_member: {
    ...
    moves: [
      ...
      { name: 'Board Decision', type: 'attack', damage: 22, stressDamage: 6, icon: '⚡', quip: '"The board has spoken."' },
    ],
  },
  ...
  the_reorg: {
    ...
    moves: [
      ...
      { name: 'Layoff Wave', type: 'attack', damage: 20, stressDamage: 8, icon: '🌊', quip: '"Efficiency optimization in progress."' },
    ],
  },
  ...
  offer_committee: {
    ...
    isBoss: true,
    phases: [
      { hpPercent: 60, moveStartIndex: 3, onEnter: { strength: 2 }, quip: '"The committee is getting serious."' },
      { hpPercent: 30, moveStartIndex: 5, onEnter: { strength: 3 }, quip: '"FINAL DELIBERATION."' },
    ],
    moves: [
      // Phase 1 (indices 0-2)
      ...
      { name: 'Committee Slam', type: 'attack', damage: 26, icon: '💥', quip: '"Motion to reject. All in favor?"' },
    ],
  },
  ...
  the_ceo: {
    ...
    isBoss: true,
    phases: [
      { hpPercent: 60, moveStartIndex: 3, onEnter: { strength: 2 }, quip: '"Enough pleasantries."' },
      { hpPercent: 30, moveStartIndex: 5, onEnter: { strength: 3 }, quip: '"I AM the company."' },
    ],
    moves: [
      ...
      { name: 'Hostile Takeover', type: 'attack', damage: 28, stressDamage: 14, icon: '☠️', quip: '"Bow before the brand."' },
    ],
  },
  ...
  imposter_syndrome_final: {
    ...
    isBoss: true,
    phases: [
      { hpPercent: 50, moveStartIndex: 3, onEnter: { strength: 2 }, quip: '"The doubt is spreading..."' },
      { hpPercent: 25, moveStartIndex: 5, onEnter: { strength: 2 }, quip: '"COMPLETE MELTDOWN IMMINENT."' },
    ],
    moves: [
      // Phase 1 (indices 0-2)
      ...
      { name: 'Complete Meltdown', type: 'attack', damage: 18, stressDamage: 25, icon: '🔥', quip: '"EVERYTHING IS FALLING APART."' },
    ],
  },
};
