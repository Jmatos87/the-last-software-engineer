...
export const backendCards: Record<string, CardDef> = {
  ...
  brute_force_attack: {
    ...
    upgradedEffects: { damage: 16, applyToSelf: { confidence: 1 } },
    upgradedDescription: 'Deal 16 damage. Gain 1 Confidence (+1 dmg per stack).',
    icon: '🔨',
  },
  memory_leak: {
    ...
    effects: { damage: 7 },
    upgradedEffects: { damage: 19 },
    upgradedDescription: 'Cost 2. Deal 19 damage. Exponential growth.',
    upgradedCost: 2,
    icon: '💾',
  },
  firewall_rules: {
  ...
  transfer_learning_backend: {
    ...
    class: 'backend', archetype: 'brute_force',
    description: 'Deal 5 damage. If you have Confidence, deal 5 more. Stress test the system.',
    effects: { damage: 5 },
