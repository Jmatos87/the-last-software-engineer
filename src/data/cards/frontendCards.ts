...
export const frontendCards: Record<string, CardDef> = {
  ...
  cascade_delete: {
    ...
    effects: { damage: 6, vulnerableDoubleHit: true },
    upgradedEffects: { damage: 8, vulnerableDoubleHit: true },
  ...
  lazy_loading: {
    ...
    class: 'frontend', archetype: 'reactive', exhaust: true,
    description: 'Exhaust a card from hand. Draw 2 cards. Gain 5 block. Only load what you need, when you need it.',
    effects: { exhaustRandom: 1, draw: 2, block: 5 },
    upgradedEffects: { exhaustRandom: 1, draw: 3, block: 7 },
    upgradedDescription: 'Cost 0. Exhaust a card from hand. Draw 3. Gain 7 block.',
    upgradedCost: 0,
    icon: '🦥',
  },
  service_worker: {
  ...
  ssr_power: {
    ...
    upgradedDescription: 'Cost 1. Gain 3 Resilience. Gain 3 Networking. Gain 3 Confidence.',
    upgradedCost: 1,
    icon: '🖥️',
  },
  devtools_breakpoint: {
