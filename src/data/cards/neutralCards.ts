...
export const neutralCards: Record<string, CardDef> = {
  ...
  the_offer: {
    ...
    description: 'Heal to full HP. Gain 2 Confidence, 2 Resilience, 1 Networking. TC: Yes. Stock: Yes. Benefits: Yes. Remote: Yes. On-call: Saturdays.',
    effects: { healFull: true, applyToSelf: { confidence: 2, resilience: 2, networking: 1 } },
    upgradedEffects: { healFull: true, applyToSelf: { confidence: 3, resilience: 3, networking: 2 } },
    upgradedDescription: 'Cost 1. Heal to full HP. Gain 3 Confidence, 3 Resilience, 2 Networking.',
    upgradedCost: 1,
    icon: '🎯',
  },
  final_sprint: {
