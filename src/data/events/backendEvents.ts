    ...
    choices: [
      ...
      },
      {
        ...
        outcome: {
          ...
          stress: -5,
          gold: 10,
          message: 'You add the fourth "DO NOT TOUCH" in your own handwriting. Gary\'s legacy endures. The mining rig continues to hum its ancient song. On the way out, you find a forgotten expense report in the drawer — unclaimed, untaxed, yours now.',
        },
      },
    ],
  },
    ...
    choices: [
      ...
      },
      {
        ...
        outcome: {
          stress: -15,
          gold: 15,
          message: 'You type it in Slack with complete confidence. It\'s not CORS. By the time the frontend team proves it\'s not CORS, the real issue has self-healed. Management sees "resolved" and approves a micro-bonus. The cause is unresolved. This is Tuesday.',
        },
      },
    ],
  },
    ...
    choices: [
      ...
      },
      {
        ...
        outcome: {
          ...
          stress: -10,
          addConsumable: 'random_rare',
          message: 'You leave $20 at the server rack as tribute. The ambient hum shifts pitch — lower, warmer. The logs clear their oldest errors. Gary\'s ghost, wherever it is, seems satisfied — and leaves something behind in return.',
        },
      },
    ],
  },
